...
from sysinformer.core.networking import (
    ...
    with patch("netifaces.interfaces") as mock_interfaces:
        ...
        with patch("netifaces.ifaddresses") as mock_ifaddresses:
            mock_ifaddresses.return_value = {
                netifaces.AF_INET: [{"addr": "192.168.1.1"}]
            }

            with patch("urllib.request.urlopen") as mock_urlopen:
                mock_urlopen.return_value.read.return_value.decode.return_value.strip.return_value = (
                    "8.8.8.8"
                )
