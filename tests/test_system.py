...
def test_get_system_info(mock_freedesktop, mock_name, mock_listdir, mock_stat, mock_machine, mock_uname, mock_node, mock_system):
    ...
    expected_result = ("Linux", "Ubuntu", "20.04", "test-host", "0 days, 0 hours, 0 minutes", "2023-01-01 00:00:00", "test-release", "test-machine", 3, "2023-01-01 00:00:00")

    with patch("time.time", return_value=50*365*24*3600):  # Returns the number of seconds in 50 years
