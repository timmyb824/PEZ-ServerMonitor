...
import pytest
from src.containers import check_if_installed, check_docker_or_podman, get_running_containers, print_running_containers
...
def test_get_running_containers(mocked_run):
    mocked_run.return_value = Mock(stdout=b'12345\tmy_container\t8000->8000/tcp\tUp About a minute')
...
def test_print_running_containers(mocked_print, mocked_get_running_containers, mocked_check_docker_or_podman):
    mocked_get_running_containers.return_value = [['12345', 'my_container', '8000:8000', 'Up About a minute']]
